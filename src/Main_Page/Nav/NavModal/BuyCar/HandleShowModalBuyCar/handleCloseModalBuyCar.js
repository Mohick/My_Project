...
export function handleCloseModalBuyCar(e) {
    let formBuyCar = document.querySelector(`.${cssNavModalBuyCar.form}`)
    let showModuleBuyCar = document.querySelector(`.${cssNavModalBuyCar.js__modal_buyCar}`)
    ...
    if (showModuleBuyCar !== null || undefined || NaN) {
        setTimeout(() => {
