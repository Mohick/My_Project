...
export default function FilterCoupe() {
                            ...
                            <Link to={'/Tìm Hiểu Thêm'}>
                                ...
                                <div className={clsx(cssCoupe.form__box_items_img, 'js-slider')}>
                                    ...
                                    {hoveredIndex === index ? (
                                        <Slider {...settings}>
                                            <div >
                                                <img className="imgSlider" src={car.img0} alt="" />
                                            </div>
                                            <div >
                                                <img className="imgSlider" src={car.img1} alt="" />
                                            </div>
                                            <div >
                                                <img className="imgSlider" src={car.img2} alt="" />
                                            </div>
                                        </Slider>
                                    ) : (
