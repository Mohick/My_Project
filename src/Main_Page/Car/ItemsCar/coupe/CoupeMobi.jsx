...
import cssCoupeMobi from './CoupeMobi.module.scss'
...
export default function CoupeMobi() {
    ...
    return (<div className={clsx(cssCoupeMobi.form)}>
        <div className={clsx(cssCoupeMobi.form__container_title, 'title-sedans')}>
            <h2 className={clsx(cssCoupeMobi.title)}>Xe Coupé</h2>
        </div>
