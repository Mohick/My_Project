...
export default function ChoseTradeCarShowAMGSendans() {
    ...
    return (filterCar.length > 0 ?
        <div className={clsx(cssSUV.form)}>
            <div className={clsx(cssSUV.form__container_title, 'title-sedans')}>
                <h2 className={clsx(cssSUV.title)}>Sedans</h2>
            </div>
