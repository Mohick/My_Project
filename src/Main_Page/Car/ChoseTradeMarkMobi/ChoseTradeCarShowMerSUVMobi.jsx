...
export default function ChoseTradeCarShowMerSUVMobi() {
    ...
    return (filterCar.length > 0 ?
        <div className={clsx(cssCoupeMobi.form)}>
            <div className={clsx(cssCoupeMobi.form__container_title, 'title-suv')}>
                <h2 className={clsx(cssCoupeMobi.title)}>Xe địa hình / SUV</h2>
            </div>
