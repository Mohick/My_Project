...
export default function ChoseTradeCarShowMBCoupeMobi() {
    ...
    return (filterCar.length > 0 ?
        <div className={clsx(cssSendas.form)}>
            <div className={clsx(cssSendas.form__container_title, 'title-coupe')}>
                <h2 className={clsx(cssSendas.title)}>Coupé</h2>
            </div>
